...
public class ScrambleCodeLogicPane extends AbstractOptionPanel {

    private JCheckBox enabledBox;

    public ScrambleCodeLogicPane() {
        super("Scramble Code Logic");
    }
    ...
    public void setOptionFromConfig() {
        enabledBox.setSelected(Processing.getConfig().getTasks().isScrambleCodeLogic());
    }
